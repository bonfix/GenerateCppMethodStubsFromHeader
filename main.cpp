...
//    student.create();
    ...
    QFile *source = new QFile("F:/program files/QT/projects/Hero/Referencing/referencelist.h");
    QFile *dest = new QFile("F:/program files/QT/projects/Hero/Referencing/referencelist.cpp");
